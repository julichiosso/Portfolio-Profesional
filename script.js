    ...
    */
    ...
    const translations = {
        es: {
            ...
            hero_bio: "Desarrollador Backend enfocado en C#, .NET y arquitecturas orientadas a servicios, con prioridad en la eficiencia y la seguridad.",
            hero_projects: "Ver Proyectos", hero_cv: "Descargar CV", hero_contact: "Contactar",
            about_title: "Sobre Mí", about_lead: "Desarrollador Backend especializado en .NET y APIs REST, con proyectos propios deployados en producción.",
            ...
            about_p2: "Construí un <strong>sistema de gestión para WEG Equipamientos Electrónicos</strong> y una <strong>plataforma completa de soporte técnico con chat en tiempo real, métricas y control de SLA</strong>. Dos proyectos deployados, con arquitectura limpia y código listo para producción.",
            about_p3: "Busco un equipo donde pueda resolver problemas reales y seguir creciendo.",
            about_card1_h: "Formación", about_card1_p: "Téc. en Programación · UTN",
            about_card2_h: "Especialidad", about_card2_p: "Backend & Full Stack",
            about_card3_h: "Interés", about_card3_p: "Inteligencia Artificial · Clean Code · Buenas Prácticas",
            ...
            prj2_title: "Gestión de Devoluciones — WEG", prj2_cat: "Enterprise / Gestión Industrial",
            prj2_desc: "Sistema que digitaliza y trazabiliza el ciclo de vida de devoluciones de mercadería, inspirado en procesos reales de WEG S.A. Incluye flujos de aprobación, control de estados y dashboards analíticos. Desarrollado como proyecto de tesis para la Tecnicatura en Programación (UTN).",
            prj3_title: "Sistema de Tickets — Helpdesk", prj3_cat: "SaaS / Soporte Técnico",
            prj3_desc: "Plataforma de gestión de soporte construida con Clean Architecture. Incluye autenticación por roles con JWT, chat en tiempo real mediante SignalR y dashboards administrativos para monitoreo de tickets. Arquitectura modular y escalable pensada para entornos corporativos.",
        ...
        en: {
            ...
            hero_bio: "Backend Developer focused on C#, .NET, and service-oriented architectures, with a priority on efficiency and security.",
            hero_projects: "View Projects", hero_cv: "Download CV", hero_contact: "Contact Me",
            about_title: "About Me", about_lead: "Backend Developer specialized in .NET and REST APIs, with personal projects deployed in production.",
            ...
            about_p2: "I built a <strong>management system for WEG Equipamientos Electrónicos</strong> and a <strong>complete technical support platform with real-time chat, metrics, and SLA control</strong>. Two deployed projects, with clean architecture and production-ready code.",
            about_p3: "I am looking for a team where I can solve real problems and keep growing.",
            about_card1_h: "Education", about_card1_p: "Programming Technician · UTN",
            about_card2_h: "Specialty", about_card2_p: "Backend & Full Stack",
            about_card3_h: "Interests", about_card3_p: "Artificial Intelligence · Clean Code · Best Practices",
            ...
            prj2_cat: "Enterprise / Industrial Management", prj2_title: "Returns Management — WEG",
            prj2_desc: "System that digitalizes and tracks the lifecycle of merchandise returns, inspired by real processes from WEG S.A. Includes approval flows, status control, and analytical dashboards. Developed as a thesis project for the Programming Technician degree (UTN).",
